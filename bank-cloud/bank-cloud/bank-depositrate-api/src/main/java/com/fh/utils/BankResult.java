...
//    }
    ...
    /**
     * 将json结果集转化为BankResult对象
     * 
     * @param jsonData json数据
     * @param clazz BankResult中的object类型
     * @return
     */
    public static BankResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, BankResult.class);
            }
     ...
     * @return
     */
    public static BankResult format(String json) {
        try {
            return MAPPER.readValue(json, BankResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static BankResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
